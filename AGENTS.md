...
- `api/AGENTS.md` covers the Vercel Python entrypoint adapter.
- `templates/AGENTS.md` covers Jinja templates and the single-page app markup.
...
Root-owned files include `app.py`, `config.py`, `requirements.txt`, `runtime.txt`, `vercel.json`, `README.md`, `.gitignore`, `.env.example`, `.claude/`, top-level images, `myflyapp-redirect.html`, and the standalone instrument preview `teste.html`.
